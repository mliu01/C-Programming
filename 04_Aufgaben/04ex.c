...
Canvas draw_circle(Canvas c, int x, int y, int diameter) {
    if (diameter%2 != 0) {
        draw_odd_circle(c, x+diameter/2, y+diameter/2, diameter/2);

    } else {
        draw_odd_circle(c, x+diameter/2-1, y+diameter/2-1, diameter/2-1);
        draw_odd_circle(c, x+diameter/2, y+diameter/2, diameter/2-1);
        draw_odd_circle(c, x+diameter/2-1, y+diameter/2, diameter/2-1);
        draw_odd_circle(c, x+diameter/2, y+diameter/2-1, diameter/2-1);
